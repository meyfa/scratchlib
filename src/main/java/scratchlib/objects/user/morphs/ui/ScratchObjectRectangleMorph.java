...
/**
 * Base class for rectangular bordered UI morphs on the Scratch stage.
 */
public class ScratchObjectRectangleMorph extends ScratchObjectBorderedMorph
{
    /**
     ...
     */
    public ScratchObjectRectangleMorph(int classID, ClassVersion version)
    {
