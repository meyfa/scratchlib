...
public class ScratchObjectTranslucentColorTest
{
    ...
    {
        ScratchObjectTranslucentColor col0 = new ScratchObjectTranslucentColor(new Color(0, 0, 0, 255));
        ...
        ScratchObjectTranslucentColor col1 = new ScratchObjectTranslucentColor(new Color(255, 255, 255, 127));
    ...
    {
        ScratchObjectTranslucentColor col0 = new ScratchObjectTranslucentColor(0, 0, 0, 255);
        ...
        ScratchObjectTranslucentColor col1 = new ScratchObjectTranslucentColor(1023, 1023, 1023, 127);
    ...
    public void writesCorrectly() throws IOException
    {
        ...
        new ScratchObjectTranslucentColor(0, 0, 0, 0).writeTo(sout, ref, project);
        new ScratchObjectTranslucentColor(500, 600, 700, 127).writeTo(sout, ref, project);
        new ScratchObjectTranslucentColor(1023, 1023, 1023, 255).writeTo(sout, ref, project);
