...
public class ScratchObjectsTest
{
    ...
    {
        assertSame(ScratchObjectBoolean.NIL, ScratchObjects.lookupConstructor(1).get());
        assertSame(ScratchObjectBoolean.FALSE, ScratchObjects.lookupConstructor(3).get());
    ...
    public void readsReferences() throws IOException
    {
        ...
        ByteArrayInputStream bin = new ByteArrayInputStream(new byte[] { 99, 0, 1, 37 });

        ScratchOptionalField result = ScratchObjects.read(new ScratchInputStream(bin), project);
    ...
    public void readsObjects() throws IOException
    {
        ...
        ByteArrayInputStream bin = new ByteArrayInputStream(new byte[] { 9, 0, 0, 0, 0 });
    ...
    public void throwsForUnknownClassID()
    {
        ...
        ByteArrayInputStream bin = new ByteArrayInputStream(new byte[] { (byte) 255, 0, 0, 0, 0 });
